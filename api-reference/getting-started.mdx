...
|:--------------|:---------|
| Extraction API |<a href="https://api.swaggerhub.com/apis/BSPK/extraction-api/1.0.0?format=json" download>https://api.swaggerhub.com/apis/BSPK/extraction-api/1.0.0?format=json</a> | 
| Platform API | <a href="https://api.swaggerhub.com/apis/BSPK/platform-api/1.0.0?format=json" download>https://api.swaggerhub.com/apis/BSPK/platform-api/1.0.0?format=json</a> |
